...
if run_button:
    ...
    st.write("Для контекста:")
    st.write("НГ 2025 - 12.6, 30 196 852 игр")
    st.write("ДР 2024 - 11.8, 22 669 675 игр")
    st.write("Гендеры 2025 - 14.1 , 30 838 473 игр")
    st.write("Хит на Гриле - 13.38, 23 806 069 игр")
